  ...
  class Notifier
    class << self
      def post_to_inboxes(activity)
        ...
        puts("Test")
        Faraday.post "https://192.168.2.102:3000/federation/actors/1/inbox", message, 'Content-Type' => 'application/json', 'Accept' => 'application/json'
        actors.each do |actor|
          actor.inbox_url = 'https://192.168.2.102:3000/federation/actors/1/inbox'
